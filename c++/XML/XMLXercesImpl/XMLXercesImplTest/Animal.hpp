 ...
 * $Id:  $
 */
#ifndef ONDALEAR_TEST_Animal_HPP
#define ONDALEAR_TEST_Animal_HPP
...
class Animal;
typedef std::vector<Animal> VectorAnimal;
...
inline std::ostream& operator<<(std::ostream& out, const Contact& contact)
{
...
inline std::ostream& operator<<(std::ostream& out, const Animal& animal)
{
    out << "Animal {\n"
        << "  name=" << animal.name( ) << ";\n"
...
#endif //ONDALEAR_TEST_DOMLoadAndSave_HPP