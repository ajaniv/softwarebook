...
class Exc(Exception):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, Exc, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, Exc, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _example.new_Exc(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_setmethods__["code"] = _example.Exc_code_set
    __swig_getmethods__["code"] = _example.Exc_code_get
    __swig_setmethods__["msg"] = _example.Exc_msg_set
    __swig_getmethods__["msg"] = _example.Exc_msg_get
    __swig_destroy__ = _example.delete_Exc
    __del__ = lambda self : None;
Exc_swigregister = _example.Exc_swigregister
Exc_swigregister(Exc)
...
class Test(_object):
    ...
    __repr__ = _swig_repr
    def simple(self): return _example.Test_simple(self)
    def message(self): return _example.Test_message(self)
    def hosed(self): return _example.Test_hosed(self)
    def unknown(self): return _example.Test_unknown(self)
    def multi(self, *args): return _example.Test_multi(self, *args)
    def __init__(self): 
